...
/*									 SBUF	=' ';
	...
	*/	
	...
	/*
	  aan=angle*100;
		...
		*/
		...
		TXBUF[2]	=	(tt4/10000)+48;
		
		TXBUF[3]	=	((tt4 % 10000)/1000)+48;
	  
		TXBUF[4]	=	((tt4 % 1000)/100)+48;
		TXBUF[5]	=	((tt4%100)/10)+48;
		TXBUF[6]	=	 (tt4%10)+48;
		TXBUF[7]	=',';
    ...
    ban=cur_speed*100;
		...
		TXBUF[9]	=	(tt3/10000)+48;
		
		TXBUF[10]	=	((tt3 % 10000)/1000)+48;
	  
		TXBUF[11]	=	((tt3 % 1000)/100)+48;
		TXBUF[12]	=	((tt3%100)/10)+48;
		TXBUF[13]	=	(tt3%10)+48;
		TXBUF[14]	=',';
	...
	if (tt5<0){
	  ...
	  TXBUF[16]	=	(tt5/10000)+48;
	
	  TXBUF[17]	=	((tt5 % 10000)/1000)+48;
  
	  TXBUF[18]	=	((tt5 % 1000)/100)+48;
	  TXBUF[19]	=	((tt5 % 100)/10)+48;
	  TXBUF[20]	=	(tt5 % 10)+48;
	  TXBUF[21]	=',';
	  TXBUF[22]='b';
